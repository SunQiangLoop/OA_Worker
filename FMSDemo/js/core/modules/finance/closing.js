...
(function () {
    ...
    function getSubjectMap() {
        ...
        const FALLBACK = {
            ...
            "5001": "生产成本",    "5101": "制造费用",
            "5201": "劳务成本",    "5301": "研发支出",
            "5401": "主营业务成本","5403": "税金及附加",
            "6001": "主营业务收入","6002": "其他业务收入",
            "6051": "利息收入",    "6111": "投资收益",
            "6301": "营业外收入",  "6401": "主营业务成本",
            "6402": "其他业务成本","6403": "税金及附加",
            "6601": "销售费用",    "6602": "管理费用",
            "6603": "财务费用",    "6701": "资产减值损失",
            "6711": "营业外支出",  "6801": "所得税费用"
        };
        Object.entries(FALLBACK).forEach(([code, name]) => map.set(code, name));
        // 再用实际科目表覆盖（优先使用用户自定义名称）
