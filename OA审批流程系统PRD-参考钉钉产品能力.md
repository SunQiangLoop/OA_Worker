...
后续可以把本文发给 AI，并使用以下提示：

> 请基于这份《OA 审批流程系统 PRD》，帮我设计一个自研 OA 审批系统。要求先输出信息架构和业务流程图，再输出 PC 管理后台页面清单、移动端页面清单、核心页面原型结构、数据库表结构和开发优先级。不要写钉钉接口对接方案，不要把它做成第三方集成系统，而是做成我们自己的审批流程系统。

## 23. 参考来源

本文只参考钉钉 OA 审批公开产品能力和概念。

| 来源 | 用途 |
|---|---|
| 钉钉开放平台 OA 审批概述 | 理解 OA 审批产品、审批表单、审批实例等基础概念 |
| 钉钉审批表单模板相关文档 | 理解审批表单、表单控件、表单模板的产品能力 |
| 钉钉流程中心相关说明 | 理解待办、审批详情、评论、审批操作等流程体验 |
